                ...
                if seleccion == 1:
                    ...
                    if contador == 0:
                        ...
                        if opcion == 1:
                            ...
                            opcion1 = int(input("Elija 1 o 2 para recibir indicaciones de llegada"))
                            if opcion1 == 1:
                                print("Tiempo en moto")
                                opcion2 = int(input("Presione 0 para salir"))
                                if opcion2 == 0:
                                    continue
                            if opcion1 == 2:
                                print("Tiempo en bicicleta")
                                opcion2 = int(input("Presione 0 para salir"))
                                if opcion2 == 0:
                                    continue
                            else:
                    ...
                    if contador == 0:
                        ...
                        latitud=coordenadas[opcion - 1][0]
                        longitud = longitud=coordenadas[opcion - 1][1]
                        usuarios = info[opcion - 1][2]
                        distance = dist[opcion - 1]
                        if opcion == 1:
                        ...
                        informacion = {"actual": [latitud, longitud],
                                       ...
                                       "recorrido": [distance[1], mediotransporte, "tiempopromedio"]
                                       }
                        imprimirlo = int(input("¿Está de acuerdo con la información a exportar?"))
                        if imprimirlo == 1:
                            print(informacion)
                    ...
                    if 1 <= seleccion <= 5:
                        ...
                        if contador == 3:
                            ...
                            condicion = False
                if seleccion == 2021:
                    lat = float(input("Dame una latitudy te diré cual hemisferio es..."))
                    if lat > 0:
